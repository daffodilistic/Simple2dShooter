...
bool GameUILayer::init()
{
	...
	do 
	{
		...
		m_UIGoldCounter = CCLabelTTF::create("m_UIGoldCounter", "Arial", 32.0f, CCSizeMake(350,32), kCCTextAlignmentLeft);
		m_UIGoldCounter->setColor(ccc3(0,0,0));
		m_UIGoldCounter->setString("0/10");
...
void GameUILayer::updatePoints(int points)
{
	char pts[8];
	sprintf(pts,"%i/10",points);
	m_UIGoldCounter->setString(pts);
}
